...
def init_db():
    ...
    if not collections:
        ...
        sample_1 = Sample(
            ...
            donor_count=90210,
            last_updated=datetime(2019, 6, 3)
        )
        sample_2 = Sample(
            collection_id=2,
            material_type="Cerebrospinal fluid",
            donor_count=512,
            last_updated=datetime(2019, 3, 8)
        )
        sample_3 = Sample(
            collection_id=2,
            material_type="Core biopsy",
            donor_count=7777,
            last_updated=datetime(2019, 5, 4)
        )
